...
Мы хотим получать следующий эффект: задачи и требования можно читать и редактировать офлайн через PR в репозиторий, а исполнение и обратная связь живут в PR и CI, где агент или контрибьютор может итеративно довести изменения до состояния “зелёное и ревью-готово”.
...
Для задач: `agent-ready`, `needs-maintainer`, `blocked`, `ai-claimed`.  
...
PR является основным каналом обратной связи для агента и ревьювера: checks, CI logs, review comments и approval status.
